...
$message_inline_callbackdata = isset($message_inline_keyboard['message']) ? $message_inline_keyboard['message'] : "";
...
else if(strpos($text, "/bachecaunipadigitale") === 0 || $text == "📱 #Unipa" || $text == "📱 #unipa")
{
	$message = isset($update['message']) ? $update['message'] : "";
		$chatId = isset($message['chat']['id']) ? $message['chat']['id'] : "";
		$text = isset($message['text']) ? $message['text'] : "";
		...
		$postField = array(
		 	'chat_id' => $chatId, 
		 	'text' => "Curioso di scoprire i contenuti di #Unipa?\nVisita https://tagboard.com/unipa/search", //http://api.openweathermap.org/data/2.5/forecast/city?id=2523920&APPID=4202cf40c6d2c97a03ae52f757754ac2
		 	'reply_markup' => array(
				 "keyboard"=> array(array("MENU PRINCIPALE"))
				,'resize_keyboard' => true
			)
...
elseif(strpos($text, "/mod3ingmec") === 0 || $text == "📄 MODULO III ING MEC" || $text == "📄 modulo iii ing mec")
{
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "http://offweb.unipa.it/offweb/calendari?cc=2055&tc=l", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/mod3ingchi") === 0 || $text == "📄 MODULO III ING CHI" || $text == "📄 modulo iii ing chi")
{
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "http://offweb.unipa.it/offweb/calendari?cc=2087&tc=l", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/mod3ingamb") === 0 || $text == "📄 MODULO III ING AMB" || $text == "📄 modulo iii ing amb")
{
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "http://offweb.unipa.it/offweb/calendari?cc=2098&tc=l", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/ingcivedi") === 0 || $text == "\xF0\x9F\x95\x92 ORARIO ING CIV-EDI" || $text == "\xF0\x9F\x95\x92 orario ing civ-edi")
{
	$message = isset($update['message']) ? $update['message'] : "";
		$chatId = isset($message['chat']['id']) ? $message['chat']['id'] : "";
		$text = isset($message['text']) ? $message['text'] : "";
...
elseif(strpos($text, "/mod3ingciv") === 0 || $text == "📄 MODULO III ING CIV" || $text == "📄 modulo iii ing civ")
{
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "http://offweb.unipa.it/offweb/calendari?cc=2022&tc=l", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/mod3ingcib") === 0 || $text == "📄 MODULO III ING CIB" || $text == "📄 modulo iii ing cib")
{
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "http://offweb.unipa.it/offweb/calendari?cc=2188&tc=l", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/mod3inggestinf") === 0 || $text == "📄 MODULO III ING GEST INF" || $text == "📄 modulo iii ing gest inf")
{
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "http://offweb.unipa.it/offweb/calendari?cc=2017&tc=l", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/mod3ingbio") === 0 || $text == "📄 MODULO III ING BIO" || $text == "📄 modulo iii ing bio")
{
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "http://offweb.unipa.it/offweb/calendari?cc=2140&tc=l", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/arch") === 0 || $text == "\xF0\x9F\x95\x92 ORARIO ARCHITETTURA" || $text == "\xF0\x9F\x95\x92 orario architettura")
{
	...
	$postField = array(
		 ...
		 'parse_mode' => 'Markdown',
		 'reply_markup' => array(
			 "keyboard"=> array(array("MENU PRINCIPALE","\xF0\x9F\x95\x92 ORARIO CORSI ARCH"),array("📄 I SEMESTRE ARCHITETTURA"),array("📄 II SEMESTRE ARCHITETTURA"))
			,'resize_keyboard' => true
		)
	);
...
elseif(strpos($text, "/mod34arch") === 0 || $text == "📄 II SEMESTRE ARCHITETTURA" || $text == "📄 ii semestre architettura")
{
	$message = isset($update['message']) ? $update['message'] : "";
		$chatId = isset($message['chat']['id']) ? $message['chat']['id'] : "";
		$text = isset($message['text']) ? $message['text'] : "";
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "https://www.unipa.it/dipartimenti/diarchitettura/cds/architettura2005/.content/documenti/allegati/20170207-lezioni-II-sem-LM4_PA.pdf", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "/disind") === 0 || $text == "\xF0\x9F\x95\x92 ORARIO DIS. INDUSTRIALE" || $text == "\xF0\x9F\x95\x92 orario dis. industriale")
{
	...
	$postField = array(
		 ...
		 'parse_mode' => 'Markdown',
		 'reply_markup' => array(
			 "keyboard"=> array(array("MENU PRINCIPALE","\xF0\x9F\x95\x92 ORARIO CORSI ARCH"),array("📄 I SEMESTRE DIS IND","📄 II SEMESTRE DIS IND"))
			,'resize_keyboard' => true
		)
	);
...
elseif(strpos($text, "/mod34disind") === 0 || $text == "📄 II SEMESTRE DIS IND" || $text == "📄 ii semestre dis ind")
{
	$message = isset($update['message']) ? $update['message'] : "";
		$chatId = isset($message['chat']['id']) ? $message['chat']['id'] : "";
		$text = isset($message['text']) ? $message['text'] : "";
...
elseif(strpos($text, "/sptupa") === 0 || $text == "\xF0\x9F\x95\x92 ORARIO SPTUPA" || $text == "\xF0\x9F\x95\x92 orario sptupa")
{
	...
	$postField = array(
		 ...
		 'parse_mode' => 'Markdown',
		 'reply_markup' => array(
			 "keyboard"=> array(array("MENU PRINCIPALE","\xF0\x9F\x95\x92 ORARIO CORSI ARCH"),array("📄 I SEMESTRE SPTUPA"),array("📄 II SEMESTRE SPTUPA"))
			,'resize_keyboard' => true
		)
	);
...
elseif(strpos($text, "/mod34sptupa") === 0 || $text == "📄 II SEMESTRE SPTUPA" || $text == "📄 ii semestre sptupa")
{
	$message = isset($update['message']) ? $update['message'] : "";
		$chatId = isset($message['chat']['id']) ? $message['chat']['id'] : "";
		$text = isset($message['text']) ? $message['text'] : "";
	...
	// change image name and path
	$postFields = array('chat_id' => $chatId, 
						'document' => "https://www.unipa.it/dipartimenti/diarchitettura/cds/scienzedellapianificazioneterritorialeurbanisticapaesaggisticaeambientale2115/.content/documenti/allegati/20170220-SPTUPA-I-e-II-sem.pdf", 
						'caption' => $text);
	$ch = curl_init(); 
	curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
	curl_setopt($ch, CURLOPT_URL, $botUrl); 
...
elseif(strpos($text, "L110") === 0 || $text == "l110" || $text == "L110")
	...
	elseif(strpos($text, "T110") === 0 || $text == "t110")
	{
		...
		$postFields = array('chat_id' => $chatId, 
						'photo' => new CURLFile(realpath("./img/mappaauleing.jpg")), 
						'caption' => "L'aula ".$text." si trova al 1° Piano dell'Ed.9 (Dip. di Ricerche Energetiche ed Ambientali) entrando dal lato destro delle scale"/*$text*/);
		$ch = curl_init(); 
		curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
		curl_setopt($ch, CURLOPT_URL, $botUrl); 
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
	...
	elseif(strpos($text, "T220") === 0 || $text == "t220")
	{
		...
		$postFields = array('chat_id' => $chatId, 
						'photo' => new CURLFile(realpath("./img/mappaauleing.jpg")), 
						'caption' => "L'aula ".$text." si trova al 2° Piano dell'Ed.9 (Dip. di Ricerche Energetiche ed Ambientali) entrando dal lato destro delle scale"/*$text*/);
		$ch = curl_init(); 
		curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
		curl_setopt($ch, CURLOPT_URL, $botUrl); 
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
	...
	elseif(strpos($text, "U110") === 0 || $text == "u110")
	{
		...
		$postFields = array('chat_id' => $chatId, 
						'photo' => new CURLFile(realpath("./img/mappaauleing.jpg")), 
						'caption' => "L'aula ".$text." si trova al 1° Piano dell'Ed.9 (DIEET - Dip. di Ingegneria Elettrica, Elettronica e delle Telecomunicazioni) entrando dal lato sinistro delle scale");
		$ch = curl_init(); 
		curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
		curl_setopt($ch, CURLOPT_URL, $botUrl); 
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
	...
	elseif(strpos($text, "USCR") === 0 || $text == "uscr")
	{
		...
		$postFields = array('chat_id' => $chatId, 
						'photo' => new CURLFile(realpath("./img/mappaauleing.jpg")), 
						'caption' => "L'aula ".$text." si trova al Piano Terra dell'Ed.9 (DIEET - Dip. di Ingegneria Elettrica, Elettronica e delle Telecomunicazioni) entrando dal lato sinistro delle scale");
		$ch = curl_init(); 
		curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type:multipart/form-data"));
		curl_setopt($ch, CURLOPT_URL, $botUrl); 
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
...
elseif(strpos($text, "/proflacascia") === 0 || $text == "La Cascia" || $text == "la cascia" || $text == "Prof La Cascia" || $text == "prof la cascia")
	...
	elseif( $text == "Crupi" || $text == "crupi" || $text == "Prof Crupi" || $text == "prof crupi" )
	{
		$message = isset($update['message']) ? $update['message'] : "";
		$chatId = isset($message['chat']['id']) ? $message['chat']['id'] : "";
		$text = isset($message['text']) ? $message['text'] : "";
		...
		$postField = array(
		 'chat_id' => $chatId, 
		 'text' => "\xF0\x9F\x91\xA4 Nome: Isodiana \n\n\xF0\x9F\x91\xA4 Cognome: Crupi \n\n\xF0\x9F\x8F\xA6 Ufficio: Ed.9\n\n📝 Ricevimento: Martedì dalle 17:00 alle 19:00 presso Viale delle Scienze, Ed. 9, 2° Piano, Stanza U218\n\n✉️ Contatti: isodiana.crupi@unipa.it", 
		 'reply_markup' => array(
			 "keyboard"=> array(array("MENU PRINCIPALE"))
			 ,'resize_keyboard' => true
			)
