...
elseif(strpos($text, "/orariolezioni") === 0 || $text == "\xF0\x9F\x95\x92 ORARIO LEZIONI" || $text == "\xF0\x9F\x95\x92 orario lezioni" || $text == "ORARIO LEZIONI" || $text == "orario lezioni")
{
	...
	$postField = array(
		 ...
		 'reply_markup' => array(
			 "keyboard"=> array(array("🏠 MENU PRINCIPALE","\xF0\x9F\x91\xA5 MENU STUDENTI"),array("\xF0\x9F\x95\x92 ORARIO CORSI ING","\xF0\x9F\x95\x92 ORARIO CORSI ARCH"),array("\xF0\x9F\x95\x92 ORARIO CORSI ECO","\xF0\x9F\x95\x92 ORARIO CORSI SC FORMAZIONE"))
			,'resize_keyboard' => true
		)
	);
...
elseif(strpos($text, "/sccommed") === 0 || $text == "\xF0\x9F\x95\x92 ORARIO SC COM MEDIA" || $text == "\xF0\x9F\x95\x92 orario sc com media")
{
	...
	$postField = array(
		 ...
		 'text' => "\xE2\x9A\xA0 Scegli fra le opzioni sotto\n\n", 
		 'reply_markup' => array(
			 "keyboard"=> array(array("📄 I SEMESTRE SC COM MEDIA"),array("\xF0\x9F\x95\x92 ORARIO CORSI SC FORMAZIONE"))
			,'resize_keyboard' => true
		)
	);
