...
elseif(strpos($text, "/menustudenti") === 0 || $text == "\xF0\x9F\x91\xA5 MENU STUDENTI" || $text == "\xF0\x9F\x91\xA5 menu studenti" )
{
	...
	$postField = array(
		 ...
		 'reply_markup' => array(
			 "keyboard"=> array(array("🏠 MENU PRINCIPALE"),array("\xF0\x9F\x95\x92 ORARIO LEZIONI TRI","\xF0\x9F\x95\x92 ORARIO LEZIONI MAG"),array("\xF0\x9F\x93\x9A MATERIE A SCELTA","\xF0\x9F\x93\x91 TIROCINIO"),array("📄 CALENDARI DIDATTICI","🏪 AULETTE ASSOCIAZIONI"))
			,'resize_keyboard' => true
		)
	);
...
elseif(strpos($text, "/oraribiblioteca") === 0 || $text == "📖 BIBLIO" || $text == "📖 biblio" || $text == "Biblioteche" || $text == "biblioteche")
{
	...
	$postField = array(
		 ...
		 'reply_markup' => array(
			 "keyboard"=> array(array("🏠 MENU PRINCIPALE","\xF0\x9F\x8F\xA6 BIBLIOTECA CENTR. INGEGNERIA"),array("\xF0\x9F\x8F\xA6 BIBLIOTECA LETTERE","\xF0\x9F\x8F\xA6 SALA LETTURA WURTH"),array("\xF0\x9F\x8F\xA6 BIBLIOTECA ARCHITETTURA","\xF0\x9F\x8F\xA6 EMEROTECA ARCH"),array("\xF0\x9F\x8F\xA6 BIBLIOTECA CLA","\xF0\x9F\x8F\xA6 BIBLIOTECA FIS CHIM ARCHIRAFI"),array("\xF0\x9F\x8F\xA6 BIBLIOTECA DICAM","\xF0\x9F\x8F\xA6 BIBLIOTECA GEOTECNICA")),
			 'resize_keyboard' => true
		)
	);
...
elseif(strpos($text, "/bibliogeo") === 0 || $text == "\xF0\x9F\x8F\xA6 BIBLIOTECA GEOTECNICA" || $text == "\xF0\x9F\x8F\xA6 biblioteca geotecnica" )
{
	$message = isset($update['message']) ? $update['message'] : "";
		...
		$postField = array(
		 	'chat_id' => $chatId, 
		 	'text' => "Si trova presso l'Edificio 8 sotto il primo portico (posizione precisa sotto)\xF0\x9F\x95\x92 Orari Esercizio:\n\nLun-Ven dalle 8:30 alle 17:00\n\nDa Settembre a Luglio\n\nℹ️ Info Utili\n\nOrario Esercizio mesi di Luglio e Agosto: dal Lunedì al Venerdì 8:30 - 14:30\n\nChiusura:\n\n
				dal 8 al 26 agosto 2016 e dal 23 dicembre 2016 al 1° gennaio 2017", 
		 	'reply_markup' => array(
