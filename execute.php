...
if(strpos($text, "/start") === 0 || $text=="\xF0\x9F\x94\xB4 START" || $text == "\xF0\x9F\x94\xB4 start")
{
	...
	$postField = array(
		...
		, 'reply_markup' => array(
			 "keyboard"=> array(array("\xF0\x9F\x91\xA5 MENU STUDENTI","\xF0\x9F\x91\xA4 INFO PROF"),array("\xF0\x9F\x8F\xAC SEGRETERIA","\xF0\x9F\x8F\xAB BIBLIO \xF0\x9F\x93\x9A","\xF0\x9F\x8F\xA2 DIPART"),array("\xF0\x9F\x8F\xA8 ERSU \xF0\x9F\x92\xB6","\xF0\x9F\x8C\x8E MAPPA","\xF0\x9F\x93\x96 CLA \xF0\x9F\x87\xAC\xF0\x9F\x87\xA7"),array("\xF0\x9F\x8D\x9D MENSA","\xF0\x9F\x8D\x94 PUNTI RISTORO","\xE2\x98\x95 MACCH. CAFFE"),array("\xF0\x9F\x93\x90 ACQUISTO MATERIALE \xF0\x9F\x93\x8F","\xE2\x81\x89 HELP","\xE2\x84\xB9 ABOUT"))
...
elseif(strpos($text, "/ristoro") === 0 || $text == "\xF0\x9F\x8D\x94 PUNTI RISTORO" || $text == "\xF0\x9F\x8D\x94 punti ristoro")
{
	...
	case "/jhonny" || "\xF0\x9F\x8D\x94 PANINERIA JHONNY" || "\xF0\x9F\x8D\x94 panineria jhonny":
	...
	default:
	{
		...
		$postField = array(
		 ...
		 'reply_markup' => array(
			 "keyboard" => array(array("\xE2\xAC\x85 BACK","\xF0\x9F\x8D\x94 PANINERIA JHONNY"),array("/pandelviale","/massaro")),
			 'resize_keyboard' => true
			)
		);
...
//Panineria da Jhonny
elseif(strpos($text, "/jhonny") === 0 )
{
	$response = "\xF0\x9F\x8D\x94 Panineria da Jhonny \n\n\xF0\x9F\x8C\x8E Localizzazione Maps \xF0\x9F\x8C\x8E\n\nhttps://goo.gl/a17ehV\n\n\xF0\x9F\x95\x92 Orari Esercizio\n\nLun-Ven dalle 11.30 alle 23.30\n\nDa Settembre a Luglio\n\n";
}

//Panineria Del Viale
elseif(strpos($text, "/pandelviale") === 0 )
{
...
elseif(strpos($text, "/menustudenti") === 0 || $text == "\xF0\x9F\x91\xA5 MENU STUDENTI" || $text == "\xF0\x9F\x91\xA5 menu studenti" )
{
	...
	$postField = array(
		 'chat_id' => $chatId, 
		 'text' => "\xF0\x9F\x8F\xA6 Menu Studenti \xF0\x9F\x8F\xA6\n\n/orariolezioni \xF0\x9F\x95\x92 ORARI LEZIONI \n\n/materieascelta \xF0\x9F\x93\x9A MATERIE A SCELTA CONSIGLIATE \n\n/tirocinio \xF0\x9F\x93\x91 TIROCINIO \n\n", 
		 'reply_markup' => array(
...
//ACQUISTO MATERIALE
elseif(strpos($text, "/acqmateriale") === 0 || $text == "\xF0\x9F\x93\x90 ACQUISTO MATERIALE \xF0\x9F\x93\x8F" || $text == "\xF0\x9F\x93\x90 acquisto materiale \xF0\x9F\x93\x8F")
	{
